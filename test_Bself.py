...
class Ballnotes(unittest.TestCase):
    ...
    def test_allnotes(self):
        ...
        time.sleep(5)
        #截图 一
        driver.get_screenshot_as_file("C:\\Users\\Administrator\\PycharmProjects\\untitled1\\picture\\pica.png")
        #点击全部
        driver.find_element(By.ID,'com.youdao.note:id/doc_all').click()
        time.sleep(2)
        #截图 二
        driver.get_screenshot_as_file("C:\\Users\\Administrator\\PycharmProjects\\untitled1\\picture\\picb.png")
        #点击最新
        driver.find_element(By.ID,"com.youdao.note:id/doc_news").click()
        #截图 三
        driver.get_screenshot_as_file("C:\\Users\\Administrator\\PycharmProjects\\untitled1\\picture\\picc.png")
    def tearDown(self):
         exitApp(self)
